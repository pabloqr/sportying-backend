...
-- CreateEnum
CREATE TYPE "reservation_status" AS ENUM ('EMPTY', 'OCCUPIED', 'CANCELLED');
...
CREATE TABLE "weather" (
    ...
    "relative_humidity_curr" DOUBLE PRECISION NOT NULL,
    "cloud_cover_curr" DOUBLE PRECISION NOT NULL,
    "wind_speed_curr" DOUBLE PRECISION NOT NULL,
    "wind_direction_curr" DOUBLE PRECISION NOT NULL,
    "precip_intensity_curr" DOUBLE PRECISION NOT NULL,
    "precip_probability_curr" DOUBLE PRECISION NOT NULL,
    "precip_probability_next" DOUBLE PRECISION NOT NULL,
    "created_at" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "weather_pkey" PRIMARY KEY ("geohash","created_at")
);
...
-- CreateIndex
CREATE INDEX "index_weather_geohash_created_at_desc" ON "weather"("geohash", "created_at" DESC);
