...
CREATE TABLE "courts_status" (
    ...
    CONSTRAINT "courts_status_pkey" PRIMARY KEY ("court_id","created")
);
...
CREATE TABLE "device_telemetry" (
    ...
    CONSTRAINT "device_telemetry_pkey" PRIMARY KEY ("device_id","created")
);
...
CREATE TABLE "notifications" (
    ...
    CONSTRAINT "notifications_pkey" PRIMARY KEY ("id","user_id","created")
);
